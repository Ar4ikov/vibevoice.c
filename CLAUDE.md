...
* **Спекулятивный декод DFlash 2** (`--draft <dir>`, `docs/DFLASH.md`,
  ...
  драфтера — jfk 2.57×, test120 2.17×, 32 мин 1.73×, 20 клипов 2.70×;
  Streaming-7B — test120 2.59×, 32 мин 2.10×, клипы 2.45×;
  Streaming-1.5B — test120 2.50×, 32 мин 2.13×, клипы 2.12×. На Hub —
  драфтеры (BF16 и `-AWQ-W4A16-ASYM`) и сборки `<AWQ-модель>-DFlash2` с
  ...
  упираются в данные (7B: 5.4 токена на блок на train против 3.7 на eval).
